...
🔗 [Repositorio Backend](https://github.com/jsgh1/juridicosquimbayapolaniaasociados-api)

---

### 🖥️ Frontend (Web)
Para desplegar la versión web, consulte el siguiente repositorio:  
🔗 [Repositorio Frontend Web](https://github.com/jsgh1/juridicosquimbayapolaniaasociados-portal)

---

### 📱 Frontend (Aplicación Móvil)
Para desplegar la aplicación móvil, consulte el siguiente repositorio:  
🔗 [Repositorio Frontend App](https://github.com/jsgh1/juridicosquimbayapolaniaasociados-app)

---

### 🛢 Base de Datos (BD)
Para desplegar la base de datos, consulte el siguiente repositorio:  
🔗 [Repositorio Base de Datos](https://github.com/jsgh1/juridicosquimbayapolaniaasociados-db)
